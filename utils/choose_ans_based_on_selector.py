...
def choose_ans_based_on_selector(scheduler_output, result_json, hallucination_threshold = 0.1):

    is_hallucination = not all(x < hallucination_threshold for x in scheduler_output)
    ...
    return selected_answer, is_hallucination
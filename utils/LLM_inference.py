...
def LLM_inference(prompt_PoT, prompt_text2sql, prompt_CoT, prompt_refine_PoT, prompt_refine_text2sql, llm, table, question, PoT_results, text2sql_results, CoT_results, N = 3, sim_threshold = 0.9):
    ...
    PoT_results["question"] = question

    text2sql_results["question"] = question

    CoT_results["question"] = question

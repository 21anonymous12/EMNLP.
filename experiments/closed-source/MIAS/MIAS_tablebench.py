...
table_raw = Tablebench.get_table()
...
with open(f'LLM_inference_results_tablebench_index_{index}.json', 'w', encoding='utf-8') as json_file:
...
print(f"Ground Truth : {Tablebench.get_answer()}") 
...
def parse_args():
    ...
    parser.add_argument('--data_root', type=str, default='./tablebench_shared_ver2')
    ...
    parser.add_argument('--task_name', type=str, default='tablebench')
    parser.add_argument('--test_split', type=str, default='tablebench_test')
    parser.add_argument('--test_number', type=int, default=10) # change the default value to run all tablebench dataset
    parser.add_argument('--seed', type=int, default=0)
    # module prediction
    parser.add_argument('--modules', nargs='+', default=None, help='default modules')
    parser.add_argument('--policy_engine', type=str, default=OPEN_AI_MODEL, help='engine for module prediction')
    ...
    # row lookup
    parser.add_argument('--rl_engine', type=str, default=OPEN_AI_MODEL, help='engine for row lookup')
    ...
    # column lookup
    parser.add_argument('--cl_engine', type=str, default=OPEN_AI_MODEL, help='engine for column lookup')
    ...
    # table verbalizer
    parser.add_argument('--tv_engine', type=str, default=OPEN_AI_MODEL, help='engine for table verbalizer')
    ...
    # knowledge retrieval
    parser.add_argument('--kr_engine', type=str, default=OPEN_AI_MODEL, help='engine for knowledge retrieval')
    ...
    # solution_generator
    parser.add_argument('--sg_engine', type=str, default=OPEN_AI_MODEL, help='engine for solution_generator')
    ...
    # program generation
    parser.add_argument('--pg_engine', type=str, default=OPEN_AI_MODEL, help='engine for program generation')
...
if __name__ == "__main__":
    ...
    # Build the solver
    solver = solver(args)
    print(f"# Number of problems: {len(solver.examples)}\n")

...
# 객체 생성
    ...
    serial_table = dataframe_to_custom_format(tabfact_table)
    infer_data = {
    ...
    'question': tabfact_question_refine,
    'output': tabfact_answer
    }
    data_list.append(infer_data)

print(f"================tabfact data length : {len(data_list)}=======================")
...
# JSON 파일로 저장
with open('tabfact_tablellama_json_test_final.json', 'w') as file:

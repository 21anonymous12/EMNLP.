...
print(f"================penguins data length : {len(data_list)}=======================")
...
# JSON 파일로 저장
with open('penguins_tablellama_json_test_final.json', 'w') as file:

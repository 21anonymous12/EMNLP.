...
table_raw = tabfact.get_table()
question_raw = tabfact.get_statement()
label = tabfact.get_label()
caption = tabfact.get_caption()
question = f'It is about {caption}. Determine whether the statement is True or False : {question_raw}'
...
with open(f'LLM_inference_results_tabfact_index_{index}.json', 'w', encoding='utf-8') as json_file:
...
print(f"Ground Truth : {tabfact_answer}") 
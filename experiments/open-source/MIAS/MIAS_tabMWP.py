...
tabMWP_df = pd.read_json('problems_train.json')
index = 7
tab_mwp = TabMWP(tabMWP_df, index)
table_raw = tab_mwp.get_table()
...
with open(f'LLM_inference_results_tabMWP_index_{index}.json', 'w', encoding='utf-8') as json_file:
...
print(f"Ground Truth : {tab_mwp.get_answer()}") 
...
with open(f'LLM_inference_results_penguins_index_{index}.json', 'w', encoding='utf-8') as json_file:
...
print(f"Ground Truth : {penguins.get_answer_extract()}") 